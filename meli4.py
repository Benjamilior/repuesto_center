...
RANGE_NAME2 = 'Verificador!v540:AB718'  # Desde W2 hasta AB
...
# Escribir datos en las columnas correctas
    range_to_write = f'precios4!{start_col}2:{end_col}'  # Escribir desde la fila 2 en adelante
...
result = sheet.values().update(
    spreadsheetId=SPREADSHEET_ID2,
    range='precios4!A1',  # Cambiar el rango según tu hoja
    valueInputOption='USER_ENTERED',
    body={'values': values}
).execute()